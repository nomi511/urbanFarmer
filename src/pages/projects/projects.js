  ...
  return (
    <div className="marketplace">
        ...
        <div className="marktet-top-nav">
            <button className='market-btn' onClick={()=>setNewProduct(true)}>Gardening</button>
            <button className='market-btn' onClick={()=>{getMyProducts()}}>Workshops</button>
            <button className='market-btn' onClick={()=>{getAllProducts()}}>Volunteers</button>
            <button className='market-btn' onClick={()=>{getAllProducts()}}>Community Gathering</button>
        </div>
